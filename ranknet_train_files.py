...
from ranknet_dataset_files import RankNet_Dataset
...
def train_save(batch_size, embed_size, bins_number, iterations, save_embedding_path):
    ...
    # dataset = PRank_Dataset(id2voc, id_cooccur, id_value, batch_size, bins_number)
    dataset = RankNet_Dataset(id2voc, small_cooccur_path, batch_size, bins_number)
